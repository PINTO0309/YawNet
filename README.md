...
- `data/yawpose/` — the unified dataset generated by `scripts/build_yawpose_dataset.py` (320x320 head crops, train:val = 9:1). See [docs/yawpose_dataset.md](docs/yawpose_dataset.md) for the spec and the full label-fix history
